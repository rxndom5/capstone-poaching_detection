...
SERVICE_ID = 'water_detector'

# --- Model Loading ---
MODEL_PATH = 'models/water.pt'
...
consumer = KafkaConsumer(
    ...
    group_id='water-detector-group' # Unique group ID
)
...
for message in consumer:
    ...
    producer.flush()
    print(f"[Water] Sent {len(detections)} detections for image ID: {image_id}")
